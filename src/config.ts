...
Do NOT use for spot prices -- use dex_get_swap_quote instead. Do NOT use for yields -- use defi_find_best_yields instead. Do NOT use for cross-exchange arbitrage scanning -- use perp_scan_funding_arbitrage instead.`,
      ...
      outputSchema: {
        ...
        properties: {
          ...
          pair: { type: "string", description: "Full pair name" },
          found: { type: "boolean", description: "Whether rates were found" },
          exchanges: { type: "number", description: "Number of exchanges with data" },
          rates: {
            type: "array",
            items: {
              type: "object",
